...
from flask_turboduck.filters import FilterForm
from flask_turboduck.filters import FilterMapping
from flask_turboduck.filters import FilterModelConverter
from flask_turboduck.forms import BaseModelConverter
from flask_turboduck.forms import ChosenAjaxSelectWidget
from flask_turboduck.forms import LimitedModelSelectField
...
from flask_turboduck.utils import path_to_models
...
class Admin(object):
    def __init__(self, app, auth, template_helper=AdminTemplateHelper,
                 prefix='/admin', name='admin', branding='flask-turboduck'):
        self.app = app
        self.auth = auth
